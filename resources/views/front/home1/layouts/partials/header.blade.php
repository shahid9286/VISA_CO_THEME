            ...
            <div class="container d-flex justify-content-between align-items-center">            
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="{{ asset('front/assets/img/logo-light.svg')}}" class="logo logo-display" alt="Logo">
                        <img src="{{asset('front/assets/img/logo.svg')}}" class="logo logo-scrolled" alt="Logo">
                    </a>
                </div>
